...
const experience = ({animateHeight}) => {
  const RightContainer = classes.Container + ' ' + classes.Right;
  const LeftContainer = classes.Container + ' ' + classes.Left;
  // if (document.documentElement.scrollTop >= 1240) {
  //   setAnimate(classes.AnimateHeightFull)
  // } else {
  //   setAnimate(classes.AnimateHeightZero)
  // }

  const animateHeightClass = animateHeight ? classes.AnimateHeightFull :  classes.AnimateHeightZero;
  ...
  return (
    <div className={classes.ExperienceWrapper}>
      <div className={classes.Experience}>
        ...
        <div className={`${classes.Timeline} ${animateHeightClass}`}>
